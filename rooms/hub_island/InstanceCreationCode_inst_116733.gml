...
else if (global.levelcomplete && (!global.beachcutscene) && global.levelcompletename != "FOREST")
{
    ...
    boatactorID = noone
    scene_info = [[cutscene_entrance_start], [cutscene_waitfor_sprite, 324], [cutscene_player_idleanim], [cutscene_change_room, 83], [cutscene_set_player_visible, false], [cutscene_player_float, true], [cutscene_set_player_pos, 923, 281], [cutscene_wait, 60], [function() //anon_gml_RoomCC_hub_island_4_Create_1208_gml_RoomCC_hub_island_4_Create
    {

function scr_editor_init_buttons() //scr_editor_init_buttons
{
    with (instance_create_depth(0, 0, -100, obj_button))
    {
        ...
        OnSelect = function() //anon_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons_208_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons
        {
            var a = [["SAVE", -4, -4], ["LOAD LEVEL", -4, -4], ["EXIT EDITOR", -4, -4]]
            create_buttons_array(0, 64, 32, 24, a)
        }

        OnDeselect = function() //anon_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons_414_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons
        {
            with (obj_button)
            {
                if (parent == other.id)
    ...
    with (instance_create_depth(128, 0, -100, obj_button))
    {
        ...
        selectedid = 0
        OnSelect = function() //anon_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons_815_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons
        {
        ...
        OnDeselect = function() //anon_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons_1810_scr_editor_init_buttons_gml_GlobalScript_scr_editor_init_buttons
        {
            with (obj_button)
            {
                if (parent == other.id)

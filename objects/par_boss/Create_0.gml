...
function SUPER_boss_hurt_noplayer(argument0) //SUPER_boss_hurt_noplayer_gml_Object_par_boss_Create_0
{
    if important
        hp -= argument0
...
function SUPER_player_hurt(argument0, argument1) //SUPER_player_hurt_gml_Object_par_boss_Create_0
{

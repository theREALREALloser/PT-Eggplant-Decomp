...
function robot_create(argument0, argument1) //robot_create_gml_Object_obj_monstertrackingrooms_Create_0
{
...
function blob_create(argument0, argument1) //blob_create_gml_Object_obj_monstertrackingrooms_Create_0
{
...
function puppet_create(argument0, argument1) //puppet_create_gml_Object_obj_monstertrackingrooms_Create_0
{
    instance_create_unique(0, 0, obj_puppetmonster)
}

function hillbilly_create(argument0, argument1) //hillbilly_create_gml_Object_obj_monstertrackingrooms_Create_0
{
...
function grid_meeting(argument0, argument1) //grid_meeting_gml_Object_obj_monstertrackingrooms_Create_0
{
...
function grid_length_x(argument0, argument1, argument2) //grid_length_x_gml_Object_obj_monstertrackingrooms_Create_0
{
    var count = 0

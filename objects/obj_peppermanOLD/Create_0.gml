...
superattack_max = 360
function player_destroy(argument0) //player_destroy_gml_Object_obj_peppermanOLD_Create_0
{
...
function boss_hurt(argument0, argument1) //boss_hurt_gml_Object_obj_peppermanOLD_Create_0
{
    if (targetstunned > 0)
    {
...
function boss_hurt_noplayer(argument0) //boss_hurt_noplayer_gml_Object_obj_peppermanOLD_Create_0
{
    if (targetstunned > 0)
    {
        targetstunned -= targetstunnedminus[(phase - 1)]

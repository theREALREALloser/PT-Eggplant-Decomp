...
if (x != targetplayer.x && targetplayer.state != states.bombpep && state != states.throw_ && bombreset == 0 && grounded)
{
...
{
    if (x != obj_player2.x && obj_player2.state != states.bombpep && state != states.throw_ && bombreset == 0 && grounded)
    {

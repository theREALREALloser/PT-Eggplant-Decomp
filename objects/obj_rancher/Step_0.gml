...
if (sprite_index != scaredspr && x != targetplayer.x && state != states.throw_ && bombreset <= 0 && grounded && targetplayer.state != states.ghost && targetplayer.state != states.ghostpossess)
{

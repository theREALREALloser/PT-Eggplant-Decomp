...
if (x != targetplayer.x && state == states.walk && state != states.throw_ && obj_player.state != states.tumble && bombreset <= 0 && grounded)
{
...
if (grounded && state == states.throw_ && floor(image_index) == 3)
    vsp = -5
if (boundbox == false)
{
